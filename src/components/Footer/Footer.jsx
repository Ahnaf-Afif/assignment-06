...
const Footer = () => {
  return (
    <div className="mt-20 bg-black text-white">
      <footer className="footer sm:footer-horizontal bg-black text-white p-10 max-w-11/12 mx-auto">
        <aside>
          <svg
            width="50"
            height="50"
      ...
      <div className="border-t-2 border-white max-w-11/12 mx-auto mt-10 flex justify-between items-center pt-5 pb-10">
